...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //1] res폴더에 정의된 모든 리소스(비트맵,XML등)를 얻어 올 수 있는 클래스
        //Resouces-getResouces()메서드로 얻는다.
        Resources resources = getResources();
        /*
         value 폴더의 strings.xml과
         drawable폴더에 있는 이미지 접근시 직접
         getString()이나 getDrawable()로 직접 접근 가능- Resouces객체 불필요
         */
        Log.i("com.kosmo.resouce09",
        ...
        //android:src속성 설정]
        //방법1] ImageView객체.setImageResouce(int 리소스 아이디)
        //imageView.setImageResource(R.drawable.picture_emergency);
        //방법2] ImageView객체.setImageDrawable(Drawable)
        //imageView.setImageDrawable(resources.getDrawable(R.drawable.picture_emergency));
        ...
        //방법3-2]BitmapFactory.decodeResouce(Resouces객체, 리소스 아이디)
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*
                int형 배열 얻어 올 때 - resources.getIntArray(int 리소스아이디)
                String형 배열 얻어 올 때 -resources.getStringArray(int 리소스아이디)
                 */
                ...
                Toast.makeText(v.getContext(),
                        ...
                        Toast.LENGTH_SHORT).show();
                Toast.makeText(v.getContext(),
                        Arrays.toString(resources.getStringArray(R.array.imageFor)),
                        Toast.LENGTH_SHORT).show();
            }
        });
    }/////onCreate
